document.addEventListener('DOMContentLoaded', () => {
    ...
    const navWealth = document.getElementById('navWealth');
    const navAdmin = document.getElementById('navAdmin');

    if (navPersonal) navPersonal.style.display = role === 'Personal' ? 'block' : 'none';
    if (navBusiness) navBusiness.style.display = role === 'Business' ? 'block' : 'none';
    if (navWealth) navWealth.style.display = role === 'Wealth' ? 'block' : 'none';
